...
impl IComponent for MidiProcessor {
    unsafe fn get_controller_class_id(&self, tuid: *mut IID) -> tresult {
        info!("Called: MidiProcessor::get_controller_class_id()");

        *tuid = MidiController::CID.clone();
        kResultOk
    }

    unsafe fn set_io_mode(&self, _mode: IoMode) -> tresult {
        info!("Called: MidiProcessor::set_io_mode()");

        kNotImplemented
    }

    unsafe fn get_bus_count(&self, type_: MediaType, dir: BusDirection) -> i32 {
        info!("Called: MidiProcessor::get_bus_count()");
    ...
    unsafe fn get_bus_info(
        ...
        info!("Called: MidiProcessor::get_bus_info()");
    ...
    unsafe fn get_routing_info(
        ...
        info!("Called: MidiProcessor::get_routing_info()");
    ...
    unsafe fn activate_bus(
        ...
        info!("Called: MidiProcessor::activate_bus()");
    ...
    unsafe fn set_active(&self, _state: TBool) -> tresult {
        info!("Called: MidiProcessor::set_active()");

        kResultOk
    }

    unsafe fn set_state(&mut self, state: *mut c_void) -> tresult {
        info!("Called: MidiProcessor::set_state()");
        ...
        let mut saved_my_param = 0.0;

        let mut saved_bypass = false;
        let gain_ptr = &mut saved_gain as *mut f64 as *mut c_void;
        let my_param_ptr = &mut saved_my_param as *mut f64 as *mut c_void;
    ...
    unsafe fn get_state(&mut self, state: *mut c_void) -> tresult {
        info!("Called: MidiProcessor::get_state()");
        ...
        let my_param_ptr = &mut self.my_param as *mut f64 as *mut c_void;
...
impl IPluginBase for MidiProcessor {
    unsafe fn initialize(&mut self, context: *mut c_void) -> tresult {
        info!("Called: MidiProcessor::initialize()");
    ...
    unsafe fn terminate(&mut self) -> tresult {
        info!("Called: MidiProcessor::terminate()");
...
impl IAudioProcessor for MidiProcessor {
    unsafe fn set_bus_arrangements(
        ...
        info!("Called: MidiProcessor::set_bus_arrangements()");
    ...
    unsafe fn get_bus_arrangements(
        ...
        info!("Called: MidiProcessor::get_bus_arrangements()");
    ...
    unsafe fn can_process_sample_size(&self, symbolic_sample_size: i32) -> tresult {
        info!("Called: MidiProcessor::can_process_sample_size()");
    ...
    unsafe fn get_latency_sample(&self) -> u32 {
        info!("Called: MidiProcessor::get_latency_sample()");

        0
    }
    unsafe fn setup_processing(&mut self, setup: *mut ProcessSetup) -> tresult {
        info!("Called: MidiProcessor::setup_processing()");
    ...
    unsafe fn set_processing(&self, _state: TBool) -> tresult {
        info!("Called: MidiProcessor::set_processing()");

        kNotImplemented
    }
    unsafe fn process(&mut self, data: *mut ProcessData) -> tresult {
        info!("Called: MidiProcessor::process()");
                ...
                if !param_queue.is_null() {
                    ...
                    match param_queue.get_parameter_id() {
                        ...
                        1 => {
                            ...
                            {
                                self.my_param = value;
                                info!("My Param value: {}", self.my_param);
                            }
                        }
                        2 => {
                            if param_queue.get_point(
    ...
    unsafe fn get_tail_samples(&self) -> u32 {
        info!("Called: MidiProcessor::get_tail_samples()");
...
impl MidiController {
    ...
    pub fn new() -> Box<Self> {
        ...
        MidiController::allocate(units, parameters, context, component_handler)
    }
...
impl IEditController for MidiController {
    unsafe fn set_component_state(&mut self, state: *mut c_void) -> tresult {
        info!("Called: MidiController::set_component_state()");
    ...
    unsafe fn set_state(&mut self, _state: *mut c_void) -> tresult {
        info!("Called: MidiController::set_state()");

        kResultOk
    }
    unsafe fn get_state(&mut self, _state: *mut c_void) -> tresult {
        info!("Called: MidiController::get_state()");

        kResultOk
    }
    unsafe fn get_parameter_count(&self) -> i32 {
        info!("Called: MidiController::get_parameter_count()");

        self.parameters.len() as i32
    }
    unsafe fn get_parameter_info(&self, param_index: i32, info: *mut ParameterInfo) -> tresult {
        info!(
            "Called: MidiController::get_parameter_info(), args: param_index = {}",
            param_index
        );
    ...
    unsafe fn get_param_string_by_value(
        ...
        info!("Called: MidiProcessor::get_param_string_by_value()");
        match id {
            0 => {
    ...
    unsafe fn get_param_value_by_string(
        ...
        info!("Called: MidiController::get_param_value_by_string()");

        kResultFalse
    }
    unsafe fn normalized_param_to_plain(&self, id: u32, value_normalized: f64) -> f64 {
        info!("Called: MidiController::normalized_param_to_plain()");
    ...
    unsafe fn plain_param_to_normalized(&self, id: u32, plain_value: f64) -> f64 {
        info!("Called: MidiController::plain_param_normalized()");
    ...
    unsafe fn get_param_normalized(&self, id: u32) -> f64 {
        info!("Called: MidiController::get_param_normalized()");
    ...
    unsafe fn set_param_normalized(&mut self, id: u32, value: f64) -> tresult {
        info!("Called: MidiController::set_param_normalized()");
    ...
    unsafe fn set_component_handler(&mut self, handler: *mut c_void) -> tresult {
        info!("Called: MidiController::set_component_handler()");
    ...
    unsafe fn create_view(&self, _name: FIDString) -> *mut c_void {
        info!("Called: MidiController::create_view()");

        null_mut()
    }
}

impl IPluginBase for MidiController {
    unsafe fn initialize(&mut self, context: *mut c_void) -> tresult {
        info!("Called: MidiController::initialize()");
        ...
        // Unit information for the controller
        ...
        wstrcpy("dB", unit_info.name.as_mut_ptr());
        ...
        let mut my_param_parameter = ParameterInfo {
            id: 1,
            title: [0; 128],
            short_title: [0; 128],
            units: [0; 128],
        ...
        wstrcpy("My", my_param_parameter.title.as_mut_ptr());
        wstrcpy("My", my_param_parameter.short_title.as_mut_ptr());
        wstrcpy("%", my_param_parameter.units.as_mut_ptr());
        // self.parameters.push((my_param_parameter, 1.0));
    ...
    unsafe fn terminate(&mut self) -> tresult {
        info!("Called: MidiController::terminate()");
...
impl IUnitInfo for MidiController {
    unsafe fn get_unit_count(&self) -> i32 {
        info!("Called: MidiController::get_unit_count()");

        1
    }

    unsafe fn get_unit_info(&self, unit_index: i32, info: *mut UnitInfo) -> i32 {
        info!("Called: MidiController::get_unit_info()");
    ...
    unsafe fn get_program_list_count(&self) -> i32 {
        info!("Called: MidiController::get_program_list_count()");

        0
    }

    unsafe fn get_program_list_info(&self, _list_index: i32, _info: *mut ProgramListInfo) -> i32 {
        info!("Called: MidiController::get_program_list_info()");
    ...
    unsafe fn get_program_name(
        ...
        info!("Called: MidiController::get_program_name()");
    ...
    unsafe fn get_program_info(
        ...
        info!("Called: MidiController::get_program_info()");

        kResultFalse
    }

    unsafe fn has_program_pitch_names(&self, _id: i32, _index: i32) -> i32 {
        info!("Called: MidiController::has_program_pitch_names()");
    ...
    unsafe fn get_program_pitch_name(
        ...
        info!("Called: MidiController::get_program_pitch_name()");

        kResultFalse
    }

    unsafe fn get_selected_unit(&self) -> i32 {
        info!("Called: MidiController::get_selected_unit()");

        0
    }

    unsafe fn select_unit(&self, _id: i32) -> i32 {
        info!("Called: MidiController::select_unit()");
    ...
    unsafe fn get_unit_by_bus(
        ...
        info!("Called: MidiController::set_unit_by_bus()");
    ...
    unsafe fn set_unit_program_data(
        ...
        info!("Called: MidiController::set_unit_program_data()");
...
impl IPluginFactory2 for Factory {
    unsafe fn get_class_info2(&self, index: i32, info: *mut PClassInfo2) -> tresult {
        ...
        match index {
            ...
            1 => {
                let info = &mut *info;
                info.cid = MidiController::CID;
                info.cardinality = ClassCardinality::kManyInstances as i32;
                strcpy("Component Controller Class", info.category.as_mut_ptr());
                strcpy("Midi VST3 Controller", info.name.as_mut_ptr());
                info.class_flags = 0;
...
impl IPluginFactory for Factory {
    ...
    unsafe fn create_instance(
        ...
        let processor_cid = MidiProcessor::CID;
        let controller_cid = MidiController::CID;

        info!("Creating instance of {:?}", *cid);
        if (*cid) == processor_cid {
            *obj = MidiProcessor::create_instance();
            info!("Created instance of MidiProcessor");
            return kResultOk;
        }
        if (*cid) == controller_cid {
            *obj = MidiController::create_instance();
            info!("Created instance of MidiController");
            return kResultOk;
        }
        warn!("CID not found");
        kResultFalse
